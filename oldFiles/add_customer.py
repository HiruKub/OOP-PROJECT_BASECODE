...
class Customer :
    def __init__(self,id,name,call,email):
        self.__id = id
        self.__name =name
        self.__call = call
        self.__email = email
...
class Clinic :
    def __init__(self,name) :
        ...
        self.__payment = None
    def create_customer(self,name,call,email) :
        ID = self.generate_ID()
        customer = Customer(ID,name,call,email)
...
@app.post("/signup") 
def payment(name : str , call : str , email : str) :
    clinic.create_customer(name,call,str)
